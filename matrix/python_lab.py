...
S_intersect_T = {x for x in S for y in T if (x in S and x in T)}
...
first_of_tuples_list = [ (i,j,k) for i in S for j in S for k in S if i+j+k == 0 and {i,j,k} != {0,0,0}][1]
